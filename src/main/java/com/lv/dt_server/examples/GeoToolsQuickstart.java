package com.lv.dt_server.examples;
...
public class GeoToolsQuickstart {
    private static final Logger LOGGER = org.geotools.util.logging.Logging.getLogger(GeoToolsQuickstart.class);
